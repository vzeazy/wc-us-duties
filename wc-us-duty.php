...
add_filter('plugin_row_meta', function ($links, $file) {
    ...
    if (!current_user_can('manage_woocommerce')) { return $links; }
    $export = sprintf('<a href="%s">%s</a>', esc_url(admin_url('admin.php?page=wrd-customs&tab=import&action=export')), esc_html__('Export Duty Rules CSV', 'woocommerce-us-duties'));
